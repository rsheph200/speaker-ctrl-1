...
const defaultLabel = 'Volume level';
...
export function SpeakerVolume({
  ...
  return (
    <section className={cls('space-y-4 text-gray-300', className)} data-component="speaker-volume">
      <div className="space-y-4">
        <label className="block text-sm uppercase tracking-wide text-gray-400">
          {label}
          <input
            type="range"
            min={min}
